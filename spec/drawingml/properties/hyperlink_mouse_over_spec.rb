...
describe OpenXml::DrawingML::Properties::HyperlinkMouseOver do
  include PropertyTestMacros

  it_should_use tag: :hlinkMouseOver, name: "hyperlink_mouse_over"
  ...
  for_attribute(:id) do
    with_value("rId256") do
      it_should_assign_successfully
      it_should_output "<a:hlinkMouseOver r:id=\"rId256\"/>"
    end
