...
describe OpenXml::DrawingML::Properties::GroupTransform do
  include PropertyTestMacros

  it_should_use tag: :xfrm, name: "group_transform"

  it_should_have_properties :offset, :extent, :child_offset, :child_extent
