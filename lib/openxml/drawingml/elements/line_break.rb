module OpenXml
  module DrawingML
    module Elements
      class LineBreak < OpenXml::Element
        include HasProperties
        namespace :a
        tag :br
        properties_tag :rPr

        # Includes the same rPr as run so that if text is added to the position
        # later, it can apply that formatting to the new text. cf. Part 1 - 21.1.2.2.1
